...
const todosReducer = createReducer(
  ...
  on(TodosActions.getTodoSuccess, (state, { todo })=> todosAdapter.setOne(todo, { ...state, selectedId: todo.id })),
  on(TodosActions.updateTodoSuccess, (state, { todo })=> todosAdapter.setOne(todo, state)),
);
